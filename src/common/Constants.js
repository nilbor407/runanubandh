...
const subscriptionAmount = 1111;
const payemntRedirectUrl = 'https://runanubandh.cloudjiffy.net/user/verifyPayment';
// const payemntRedirectUrl = 'http://localhost:8085/user/verifyPayment';

const frontendPaymentRedirectURL = 'https://runanubandhvishwavivah.com/userDetails';
